...
class ParcialidadManager:
    ...
    def update_parcialidad(self, id_parcialidad: str, data, headers):
        self.logger.info("Actualizando parcialidad con id %s y datos: %s", id_parcialidad, data)
    ...
    def list_parcialidades(self, page: int, page_size: int, headers):
        self.logger.info("Listando parcialidades con page=%s y page_size=%s", page, page_size)
        return self.client_parcialidad.list_parcialidades(page=page, page_size=page_size, headers=headers)
